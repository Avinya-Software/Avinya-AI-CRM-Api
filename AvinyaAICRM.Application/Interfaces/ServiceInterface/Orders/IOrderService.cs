...
namespace AvinyaAICRM.Application.Interfaces.ServiceInterface.Orders
{
    public interface IOrderService
    {
        ...
        Task<ResponseModel> GetFilteredAsync(string? search, int page, int pageSize, string userId, string? role, int? statusFilter = null, DateTime? from = null, DateTime? to = null);
