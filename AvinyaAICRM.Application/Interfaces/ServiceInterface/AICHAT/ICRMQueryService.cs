...
namespace AvinyaAICRM.Application.Interfaces.ServiceInterface.AICHAT
{
    ...
    {
        Task<List<Dictionary<string, object>>> ExecuteRawSqlAsync(string sql, Guid tenantId, bool isSuperAdmin, string userId = "", string contextMessage = "", List<string> allowedModules = null);
