...
namespace AvinyaAICRM.Domain.Constant
{
    public static class AISchema
    {
        public static Dictionary<string, string> Tables = new Dictionary<string, string>
        {
            ...
            { "Orders", "dbo.Orders(OrderID [PK], OrderNo, ClientID [ref: dbo.Clients], QuotationID [ref: dbo.Quotations], OrderDate, ExpectedDeliveryDate, Status [ref: dbo.OrderStatusMaster.StatusID], DesignStatusID [ref: dbo.DesignStatusMaster], CreatedBy [ref: dbo.AspNetUsers], AssignedDesignTo [ref: dbo.AspNetUsers], CreatedDate, SubTotal, TotalTaxes, GrandTotal, ShippingAddress, TenantId)" },
